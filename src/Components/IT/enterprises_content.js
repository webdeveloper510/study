            ...
            <Container>
              ...
              <Navbar.Collapse id="basic-navbar-nav">
                <Nav className="ms-auto">
                  <Nav.Link  href="/enterprises_info">Home</Nav.Link>
                  <Nav.Link className='active' href="/enterprises_content">Destination</Nav.Link>
...
export default enterprises_content