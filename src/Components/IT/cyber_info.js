            ...
            <Container>
              ...
              <Navbar.Collapse id="basic-navbar-nav">
                <Nav className="ms-auto">
                  <Nav.Link className='active' href="/cyber_info">Home</Nav.Link>
                  <Nav.Link href="/cyber_content">Destination</Nav.Link>
        ...
        <div className='overlay1'>
          <Container>
            <Row>
              <Col md={7}>
                <div className='mt-4'>
                  <h3 className='title'>IMPLEMENTING AND MANAGING CYBER SECURITY</h3>
                  <h4 className='title'>Why get the RSD?</h4>
                  <p>-To gain the necessary knowledge and understanding of securing computing systems.</p>
                  <p>-To learn how to implement and manage cyber security in an enterprise environment.</p>
                  <p>-To know the core principles to consider in order to secure systems appropriately.</p>
                  <p>-To develop the knowledge and skills relating to security, detection, information and attack management in order to protect an organisation in the event of a cyber-security attack.</p>
                </div>
              </Col>
