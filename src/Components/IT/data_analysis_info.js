            ...
            <Container>
              ...
              <Navbar.Collapse id="basic-navbar-nav">
                <Nav className="ms-auto">
                  <Nav.Link className='active' href="/data_analysis_info">Home</Nav.Link>
        ...
        <div className='overlay1'>
          <Container>
            <Row>
              <Col md={7}>
                <div className='mt-4'>
                  <h3 className='title'>DATA ANALYSIS AND BIG DATA </h3>
                  <h4 className='title'>Why get the RSD?</h4>
                  <p>-To learn about the importance and uses of big data in today’s world..</p>
                  <p>-To understand how data analysis and big data can be used to provide greater knowledge in certain areas..</p>
                  <p>-To gain knowledge of the considerations that need to be made in relation to storing, searching and reporting on big data sets.</p>
                </div>
              </Col>
