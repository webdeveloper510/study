            ...
            <Container>
              ...
              <Navbar.Collapse id="basic-navbar-nav">
                <Nav className="ms-auto">
                  <Nav.Link  href="/cyber_info">Home</Nav.Link>
                  <Nav.Link className='active' href="/cyber_content">Destination</Nav.Link>
