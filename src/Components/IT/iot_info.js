            ...
            <Container>
              ...
              <Navbar.Collapse id="basic-navbar-nav">
                <Nav className="ms-auto">
                  <Nav.Link className='active' href="/iot_info">Home</Nav.Link>
        ...
        <div className='overlay1'>
          <Container>
            <Row>
              <Col md={7}>
                <div className='mt-4'>
                  <h3 className='title'>INTERNET OF THINGS (IoT) </h3>
                  <h4 className='title'>Why get the RSD?</h4>
                  <p>-To gain core knowledge and understanding of Internet of Things (IoT) technologies.</p>
                  <p>-To understand how IoT is used today to increase productivity and efficiency across personal and business life, identifying its use in the future.</p>
                  <p>-To explore the underlying technologies that make functionary possible.</p>
                </div>
              </Col>
