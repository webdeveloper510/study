        ...
        <div className='overlay1'>
          <Container>
            <Row>
              <Col md={7}>
                <div className='mt-4'>
                  <h3 className='title'>NETWORKING AND INFRASTRUCTURE DEVELOPMENT  </h3>
                  <h4 className='title'>Why get the RSD?</h4>
                  <p>-	To gain the knowledge and understanding of networks used within computing environments.  </p>
                  <p>-	To understand the importance of ensuring a network is designed appropriately, is scalable and fit for purpose.  </p>
                  <p>-	To learn the considerations that must be made when designing an infrastructure environment.</p>
                </div>
              </Col>
...
export default Networking_info