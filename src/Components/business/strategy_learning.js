            ...
            <Container>
              ...
              <Navbar.Collapse id="basic-navbar-nav">
                <Nav className="ms-auto">
                  <Nav.Link  href="/strategy_info">Home</Nav.Link>
                  <Nav.Link className='active' href="/strategy_learning">Destination</Nav.Link>
...
export default strategy_learning