            ...
            <Container>
              ...
              <Navbar.Collapse id="basic-navbar-nav">
                <Nav className="ms-auto">
                  <Nav.Link className='active' href="/it_info">Home</Nav.Link>
                  <Nav.Link href="/it_learning">Destination</Nav.Link>
        ...
        <div className='overlay1'>
          <Container>
            <Row>
              <Col md={7}>
                <div className='mt-4'>
                  <h3 className='title'>BUSINESS INFORMATION TECHNOLOGY SYSTEMS</h3>
                  <h4 className='title'>Why get the RSD?</h4>
                  <p>-To enhance students’ understanding of contemporary business information technology (IT) systems.</p>
                  <p>-To educate the students on how organisations develop and continuously review their IT strategy in order to gain and maintain competitive advantage.</p>
                  <p>-To explore the areas of business that benefit from the support of IT systems and how organisations are using IT as a driver for business improvement.</p>
                </div>
              </Col>
