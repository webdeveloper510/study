            ...
            <Container>
              ...
              <Navbar.Collapse id="basic-navbar-nav">
                <Nav className="ms-auto">
                  <Nav.Link className='active' href="/enterpreneour_info">Home</Nav.Link>
                  <Nav.Link href="/enterpreneour_learn">Destination</Nav.Link>
        ...
        <div className='overlay1'>
          <Container>
            <Row>
              <Col md={7}>
                <div className='mt-4'>
                  <h3 className='title'>ENTREPRENEURSHIP AND SMALL BUSINESS MANAGEMENT</h3>
                  <h4 className='title'>Why get the RSD?</h4>
                  <p>-To have a practical understanding of the key aspects of running a small business or social enterprise.</p>
                  <p>-To learn about the activities involved in running a small business.</p>
                  <p>-To develop an understanding of how all the different aspects of running a business interrelate so as to achieve success and develop an appreciation of the benefits and importance of organisation and planning.</p>
                </div>
              </Col>
