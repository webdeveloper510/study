            ...
            <Container>
              ...
              <Navbar.Collapse id="basic-navbar-nav">
                <Nav className="ms-auto">
                  <Nav.Link className='active' href="/innovation">Home</Nav.Link>
        ...
        <div className='overlay1'>
          <Container>
            <Row>
              <Col md={7}>
                <div className='mt-4'>
                  <h3 className='title'>BRAND MANAGEMENT</h3>
                  <h4 className='title'>Why get the RSD?</h4>
                  <p>-Brand management is an important aspect of marketing and boosts product value for any business.</p>
                  <p>-To gain end-to-end understanding of brand management.</p>
                  <p>-To explore a range of tools and techniques that can be employed to maximise brand value.</p>
                  <p>-To learn how to measure brand value and manage a portfolio of brands over time.</p>
                </div>
              </Col>
